...
var optimist = require("optimist")
	...
	.describe("public", "The public hostname/ip address of the server").default("public", "localhost")
...
if(argv.public !== "localhost" || !options.public)
...
if(options.inline) {
	var devClient = [require.resolve("../client/") + "?" + protocol + "://" + options.public + ":" + options.port];
